<nav class="sidebar-nav scroll-sidebar" data-simplebar>
    <ul id="sidebarnav">
        ...
        @can('popup-view')
            <li class="sidebar-item">
                <a class="sidebar-link @if (Route::is('admin.popups.*')) active @endif"
                    href="{{ route('admin.popups.index') }}" aria-expanded="false">
                    <span>
                     <i class="ti ti-phone-call"></i>
                    </span>
                    <span class="hide-menu">Request Callbacks</span>
                </a>
            </li>
        @endcan
