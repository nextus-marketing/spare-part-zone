@component('mail::message')
    <p style="border-collapse: collapse; table-layout: fixed; width: 1000px;">
        Hi,<br />
        New enquiry has been initiated on The Spare Part Zone
        <br />
    ...
    <table style="border-collapse: collapse; table-layout: fixed; width: 1000px;">
        <tbody>
            ...
            @if (isset($data['vin']))
                <tr>
                    <td style="border: 1px solid black; padding: 10px; width: 100px; overflow: hidden;"><b>VIN Number</b></td>
                    <td style="border: 1px solid black; padding: 10px;"><b>&nbsp;&nbsp;{!! $data['vin'] !!}</b></td>
                </tr>
            @endif
            @if (isset($data['purchase_time']))
                <tr>
                    <td style="border: 1px solid black; padding: 10px; width: 100px; overflow: hidden;"><b>Purchase Decision</b></td>
                    <td style="border: 1px solid black; padding: 10px;"><b>&nbsp;&nbsp;{!! $data['purchase_time'] !!}</b></td>
                </tr>
            @endif
            @if (isset($data['form_name']))
                <tr>
                    ...
                    <td style="border: 1px solid black; padding: 10px;"><b>&nbsp;&nbsp;{!! $data['form_name'] !!}</b></td>
                </tr>
            @endif
            @if (isset($data['notes']))
                <tr>
                    <td style="border: 1px solid black; padding: 10px; width: 100px; overflow: hidden;"><b>Notes</b></td>
                    <td style="border: 1px solid black; padding: 10px;"><b>&nbsp;&nbsp;{!! $data['notes'] !!}</b></td>
                </tr>
            @endif
