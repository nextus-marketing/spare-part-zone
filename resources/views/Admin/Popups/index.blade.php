                    ...
                    <div class="card-header px-4 py-3 border-bottom">
                        <div class="row">
                            <div class="col-6 d-flex justify-content-start">
                                <h5 class="card-title fw-semibold mb-0 lh-sm">Request Callbacks</h5>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table border table-bordered table-sm mb-0 align-middle" id="datatable">
                                <thead class="text-dark fs-3">
                                    <tr>
                                        ...
                                        <th>
                                            <h6 class="fs-3 fw-semibold mb-0">Zip</h6>
                                        </th>
                                        <th>
                                        ...
                                        <th>
                                            <h6 class="fs-3 fw-semibold mb-0">IP Address</h6>
                                        </th>
                                    </tr>
                                </thead>
                            </table>
        ...
        $(function() {
            var dataTable = $('#datatable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'part_name',
                        name: 'popups.part_name'
                    },
                    {
                        data: 'ip_address',
                        name: 'popups.ip_address'
                    },
                ],
                order: [],
                columnDefs: [{
