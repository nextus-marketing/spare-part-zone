                ...
                <div class="card w-100">
                    ...
                    <div class="card-body border-top">
                     <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <label class="control-label col-form-label">First Name <sup class="tcul-star-restrict">*</sup></label>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <label class="control-label col-form-label">Last Name <sup class="tcul-star-restrict">*</sup></label>
                    ...
                    <br/>
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <label class="control-label col-form-label">Employee ID <sup class="tcul-star-restrict">*</sup></label>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <label class="control-label col-form-label">Designation <sup class="tcul-star-restrict">*</sup></label>
                                <input type="text" class="form-control" placeholder="Designation" name="designation"
                                    value="{{ isset($employee) ? $employee->designation : '' }}" />
                                <div id="designation-error" style="color:red"></div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <label class="control-label col-form-label">Role(s) <sup class="tcul-star-restrict">*</sup></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <label class="control-label col-form-label">E-Mail <sup class="tcul-star-restrict">*</sup></label>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <label class="control-label col-form-label">Password <sup class="tcul-star-restrict">*</sup></label>
                                <input type="text" class="form-control" placeholder="Password" name="password"
                                    value="{{ isset($employee) ? $employee->user->text_password : '' }}" />
                                <div id="password-error" style="color:red"></div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <label class="control-label col-form-label">Confirm Password <sup class="tcul-star-restrict">*</sup></label>
