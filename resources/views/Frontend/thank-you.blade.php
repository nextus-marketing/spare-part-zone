                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="error__content text-center">
                            ...
                            <p class="error__content--desc">Your part request has been successfully received. Our team will begin reviewing your selection immediately.</p>
                            <p class="error__content--desc">Need immediate assistance? Call our experts:</p>
