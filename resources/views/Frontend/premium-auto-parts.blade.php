@extends('layouts.frontend')
    ...
    <style>
        ...
        /* Hide parent layout duplicate footer on premium-auto-parts landing page */
        footer.h-d, footer.h-m, footer.h-d.h-m {
            display: none !important;
        }
        /* Sticky header on Desktop for premium-auto-parts landing page */
...
/* 
                ...
                .swiper-slide::before {
                    ...
                    position: absolute;
                    inset: 0;
                    background: rgba(0, 0, 0, 0.2) !important; /* adjust darkness */
                    z-index: 1;
                }
    ...
    <main class="main__content_wrapper" id="home" style="font-family: 'Manrope', sans-serif;">
        <div id="form"></div>
        ...
        <section class="hero__slider--section slider__section--bg3" style="padding: 0; margin: 0;">
            ...
            <div class="hero__slider--inner noninteractive-slider swiper">
                ...
                <div class="swiper-slide"
                    style="background: url('/frontend/my_img/banner/banner-12.png') no-repeat center center / cover;">
                    ...
                    <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                        <div class="slider__content style3 container" style="margin-left: 0;">
                            <span class="slider__subtitle style3">Your Trusted Auto Parts Supplier</span>
                            <h1 class="slider__maintitle style3 text__secondary h2">The Parts You Need.  <br>
                            <span class="highlight">The Quality</span> You Trust.
                            </h1>
                            <p class="slider__desc style3" style="color: white;">Friendly Experts Ready to Assist You</p>
                            <a class="primary__btn slider__btn openPopup" href="tel:+18555815811">
...
<section class="container py-5 verified-parts-section">
    <div class="text-center mb-5">
        <h2 class="section-title" style="color:#ff4e21; font-size:2.3rem; line-height:1.2">Every Auto Part Professionally Inspected</h2>
        <p>Find millions of used auto parts from local salvage yards on our massive auto salvage database.</p>
    </div>
    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-12 col-sm-6 col-lg-4">
            <div class="verified-card h-100 text-center">
                <div class="verified-thumb">
                    <img src="/frontend/my_img/rack-1.jpg" alt="Front Bumper Assembly" class="img-fluid">
                </div>
                <h3 class="verified-title">
                    <a href="#0">
                     OEM Engines, Transmissions & More
                    </a>
                </h3>
                <a href="tel:+18555815811" class="verified-call-btn">
                    <i class="fa-solid fa-phone pulse-icon"></i> Call Now
                </a>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-lg-4">
            <div class="verified-card h-100 text-center">
                <div class="verified-thumb">
                    <img src="/frontend/my_img/rack-2.webp" alt="Certified Auto Engine" class="img-fluid">
                </div>
                <h3 class="verified-title">
                    <a href="#0">
                       Complete Auto Parts Warehouse
                    </a>
                </h3>
                <a href="tel:+18555815811" class="verified-call-btn">
                    <i class="fa-solid fa-phone pulse-icon"></i> Call Now
        ...
        <div class="col-12 col-sm-6 col-lg-4">
            <div class="verified-card h-100 text-center">
                <div class="verified-thumb">
                    <img src="/frontend/my_img/rack-3.jpg" alt="Trusted Transmission" class="img-fluid">
                </div>
                <h3 class="verified-title">
                    <a href="#0">
                      Quality Tested Exterior Parts
                    </a>
                </h3>
                <a href="tel:+18555815811" class="verified-call-btn">
                    <i class="fa-solid fa-phone pulse-icon"></i> Call Now
...
<style>
    ...
    @media (max-width: 576px) {
        ...
        <section class="about__section section--padding mb-95" id="about-us" style="scroll-margin-top: 80px;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="counter-card text-center">
                            <span class="counterup__number js-counter" data-count="400000">0</span>
                ...
                <div class="col-md-6">
                    <div class="category-card" style="background-image:url('/frontend/my_img/body-parts.png')">
                        <div class="category-overlay">
                            ...
                            <a href="tel:+1 (855) 581-5811" class="category-btn"><i class="fa-solid fa-phone pulse-icon me-3"></i>Call Now</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="text-center mb-5">
        ...
        <p class="journey-subheading">Your journey to getting your vehicle back on the road!</p>
    </div>
...
<style>
    ...
    @media (max-width: 576px) {
        ...
        <section class="categories__section section--padding">
            <div class="container">
                <div class="section__heading border-bottom mb-30">
                    ...
                    <p>We offer quality used <b>Spare Part Zone</b> from all major brands. If you're looking for a high quality auto part replacement, then simply <a href="tel:+18555815811" class="custom-link"><b>Call Now</b></a> to discover your available options</p>
                </div>
        ...
        <section class="call-us-section" id="contact-us" style="scroll-margin-top: 80px;">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <div class="call-card">
        ...
        <footer class="footer__section footer__bg landing-footer">
            <div class="container">
                ...
                <div class="main__footer">
                    <div class="row ">
                            ...
                            <div class="footer__widget">
                                ...
                                <ul class="footer__widget--menu">
                                    <li class="footer__widget--menu__list">
                                        <a class="footer__widget--menu__text" href="#home">Home</a>
                                    </li>
                                    <li class="footer__widget--menu__list">
                                        <a class="footer__widget--menu__text" href="#about-us">About Us</a>
                                    </li>
                                    <li class="footer__widget--menu__list">
                                        <a class="footer__widget--menu__text" href="#contact-us">Contact Us</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 mt-3 mt-md-0">
                            <div class="footer__widget">
                                <h2 class="footer__widget--title ">Resources</h2>
                                <ul class="footer__widget--menu">
     ...
     <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            logoLink.addEventListener("click", function (e) {
                ...
                if (currentPath === "/used-vehicle-parts") {
    ...
    <!-- 24-Hour Flash Deal Countdown -->
    <!-- 1-Hour Flash Deal Countdown (resets every page load) -->
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Always start fresh — no localStorage, so every refresh = 1 hour again
...
<script>
document.addEventListener("DOMContentLoaded", function () {
    // Setup Desktop Header Menu: Home, About Us, Contact Us only
    const desktopMenuWrapper = document.querySelector(".header__menu--wrapper");
    if (desktopMenuWrapper) {
        const menuItems = desktopMenuWrapper.querySelectorAll("li.header__menu--items");
        menuItems.forEach(function(item) {
            item.style.display = "none";
        });

        if (!desktopMenuWrapper.querySelector(".landing-desktop-nav")) {
            const navHtml = `
                <li class="header__menu--items landing-desktop-nav">
                    <a class="header__menu--link text-white" href="#home">Home</a>
                </li>
                <li class="header__menu--items landing-desktop-nav">
                    <a class="header__menu--link text-white" href="#about-us">About Us</a>
                </li>
                <li class="header__menu--items landing-desktop-nav">
                    <a class="header__menu--link text-white" href="#contact-us">Contact Us</a>
                </li>
            `;
            desktopMenuWrapper.insertAdjacentHTML("afterbegin", navHtml);
        }
    }

    // Setup Mobile Offcanvas Menu: Home, About Us, Contact Us only
    const mobileMenuUl = document.querySelector(".offcanvas__menu_ul");
    if (mobileMenuUl) {
        mobileMenuUl.innerHTML = `
            <li class="offcanvas__menu_li">
                <a class="offcanvas__menu_item landing-mobile-link" href="#home">Home</a>
            </li>
            <li class="offcanvas__menu_li">
                <a class="offcanvas__menu_item landing-mobile-link" href="#about-us">About Us</a>
            </li>
            <li class="offcanvas__menu_li">
                <a class="offcanvas__menu_item landing-mobile-link" href="#contact-us">Contact Us</a>
            </li>
        `;
    }

    // Smooth scroll and offcanvas auto-close handler
    document.addEventListener("click", function (e) {
        ...
        if (!targetElement && (targetId === '#about' || targetId === '#about-us')) {
            targetElement = document.querySelector('#about-us') || document.querySelector('#about');
        }
        if (!targetElement && (targetId === '#contact' || targetId === '#contact-us')) {
            targetElement = document.querySelector('#contact-us') || document.querySelector('#contact');
        }
