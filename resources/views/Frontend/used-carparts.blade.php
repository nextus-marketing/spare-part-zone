                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Used Car Parts Page" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content">
                            ...
                            <span class="about__content--subtitle text__secondary mb-20"> About Us</span>
            ...
            <div class="container">
                ...
                <div class="categories__inner--style3 d-flex">
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/1.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/2.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/3.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/4.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/5.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/6.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/7.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/8.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/9.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/10.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/11.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/12.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/13.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/14.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/15.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/16.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/17.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/18.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/19.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/20.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/21.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/22.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/23.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/24.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/25.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/28.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/29.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/30.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/31.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/32.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/33.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                    <div class="categories__card--style3 text-center">
                        <a class="categories__card--link">
                            <div class="categories__thumbnail">
                                <img class="categories__thumbnail--img" src="/frontend/my_img/another-brands/34.png" alt="categories-img">
                            </div>
                        </a>
                    </div>
                </div>
