...
@section('title') Auto Parts | Spare Part Zone @endsection
@section('robots')
...
<style>
    ...
    .a-s {
        ...
        /* FORCE icon + text in ONE LINE on mobile */
            @media (max-width: 767px) {
...
<style>
    ...
    .search-box input:focus {
        border-color: #ff4e21;
        box-shadow: 0 0 0 3px rgba(247, 21, 28, 0.1);
        outline: none;
    }
...
<style>
    /* Make grid items stretch evenly */
    .custom-col {
        display: flex;
    }
    ...
    /* Optional: consistent button spacing */
    ...
    <section class="hero__slider--section slider__section--bg3" style="padding: 0; margin: 0;">
        ...
        <div class="hero__slider--inner noninteractive-slider swiper">
            ...
            <div class="swiper-slide"
                style="background: url('/frontend/my_img/banner/banner-9.jpg') no-repeat center center / cover; ">
                ...
                <div class="slider__content style3 container" style="margin-left: 0;">
                    <div class="hero__tags">
                        <div class="hero__tag mb-10">
                            <i class="fa-solid fa-bookmark"></i>
                            3000+ Genuine Auto Parts
                        </div>

                        <div class="hero__tag mb-10">
                            <i class="fa-solid fa-bookmark"></i>
                            OEM And JDM Car Parts
                        </div>

                        <div class="hero__tag mb-10">
                            <i class="fa-solid fa-bookmark"></i>
                            Competitive Price Assured
                        </div>

                        <div class="hero__tag mb-10">
                            <i class="fa-solid fa-bookmark"></i>
                            50000+ Satisfied Customers
                        </div>

                        <div class="hero__tag mb-10">
                            <i class="fa-solid fa-bookmark"></i>
                            15 Days Assured Return
                        </div>

                        <div class="hero__tag mb-10">
                            <i class="fa-solid fa-bookmark"></i>
                            100% Matching Car Parts
                        </div>

                        <div class="hero__tag mb-10">
                            <i class="fa-solid fa-bookmark"></i>
                            3 Months Warranty On All Purchases
                        </div>
                    </div>
                </div>
                ...
                <!-- 📦 START: FORM IN BANNER -->
                    <div class="banner__form">
                        ...
                        <h3 class="form-title">Let’s find the perfect Used Car Parts for you.</h3>
                        ...
                        <div class="form-steps">
                            <div class="step active" id="stepIndicator1" style="cursor:pointer;">
                                <span>1</span> Vehicle & Part Info
                            </div>
                            <div class="step" id="stepIndicator2" style="cursor:pointer;">
                        ...
                        <form action="/lead-enquiry" method="POST" class="leadForm">
                            @csrf
                            <input type="hidden" value="Auto Parts Page (Used Car Parts)" id="form_name" name="form_name">
                            <!-- ================= STEP 1 ================= -->
                            <div id="step-1">
                                ...
                                <div class="form-row-label">
                                    ...
                                    <input type="text" name="vehicle_model" id="vehicle_model" placeholder="Enter Vehicle Model">
                                    <div class="field_error" id="vehicle_model-error" style="color:#ff4e21; font-size:12px;"></div>
                                </div>

                                <div class="form-row-label">
                                    <label><span class="required">*</span>Part Name</label>
                                    <input type="text" name="part_name" id="part_name" placeholder="Enter Part Name">
                                    <div class="field_error" id="part_name-error" style="color:#ff4e21; font-size:12px;"></div>
                                </div>

                                <div class="form-row-label mb-2">
                                    <label>VIN (Optional)</label>
                                    <input type="text" name="vin" id="vin" placeholder="Enter VIN Number">
                                </div>
                            ...
                            <div id="step-2" style="display:none;">
                                ...
                                <div class="form-row-label mb-2">
                                    ...
                                    <select name="purchase_time" id="purchase_time">
                                        <option value="" disabled selected>When do you plan to purchase?</option>
                                ...
                                <textarea name="notes" id="notes" class="inline-textarea"
                ...
                <div class="call-btn-wrapper">
                    <a href="tel:+18555815811" class="call-btn-mobile">
                        <i class="fa-solid fa-phone"></i> +1 (855) 581-5811
                    </a>
                </div>
    ...
    <div id="noResults" class="no-results-box">
        ...
        <div class="call-btn-wrapper" style="margin-left: 16px;">
            <a href="tel:+18555815811" class="call-btn-mobile">
                <i class="fa-solid fa-phone"></i> +1 (855) 581-5811
            </a>
        </div>
                    ...
                    <div id="product_grid" class="tab_pane active show">
                        <div class="product__section--inner">
                            <div class="row mb--n30 justify-content-center">
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-engine">
                                                <img class="" src="/frontend/my_img/Main/engine.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-engine">Car Engine</a></h3>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-cylinder-head">
                                                <img class="" src="/frontend/my_img/Main/cylinder_head.jpg" alt="product-img">
                                            </a>
                                        </div>
                                            <div class="product__card--content">
                                                <h3 class="product__card--title text-center"><a href="/used-carparts/car-cylinder-head">Cylinder Head</a></h3>
                                                    <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-camshaft">
                                                <img class="" src="/frontend/my_img/Main/camshaft.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-camshaft">Camshaft</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-supercharger">
                                                <img class="" src="/frontend/my_img/Main/supercharger.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-supercharger">Supercharger</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-turbocharger">
                                                <img class="" src="/frontend/my_img/Main/turbo-charger.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-turbocharger">Turbocharger</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-intake-manifold">
                                                <img class="" src="/frontend/my_img/Main/intake_manifold.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-intake-manifold">Intake Manifold</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-exhaust-manifold">
                                                <img class="" src="/frontend/my_img/Main/exhaust_manifold.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-exhaust-manifold">Exhaust Manifold </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-throttle-body">
                                                <img class="" src="/frontend/my_img/Main/throttle_body.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-throttle-body">Throttle Body </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-engine-mount">
                                                <img class="" src="/frontend/my_img/Main/engine-mount.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-engine-mount">Engine Mount </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-valve-cover">
                                                <img class="" src="/frontend/my_img/Main/valve-cover.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-valve-cover">Valve Cover </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-fuel-pump">
                                                <img class="" src="/frontend/my_img/Main/fuel_pump.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-fuel-pump">Fuel Pump </a></h3>
                                                <div class="mt-3" style="display: flex; justify-content: center;">
                                                    <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                        <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                        Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-coolant-pump">
                                                <img class="" src="/frontend/my_img/Main/coolant_pump.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-coolant-pump">Coolant Pump</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-radiator">
                                                <img class="" src="/frontend/my_img/Main/car-radiator.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-radiator">Radiator</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-vacuum-pump">
                                                <img class="" src="/frontend/my_img/Main/vacuum_pump.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-vacuum-pump">Vacuum Pump </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-catalytic-converter">
                                                <img class="" src="/frontend/my_img/Main/catalytic_converter.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-catalytic-converter">Catalytic Converter </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-transmission">
                                                <img class="" src="/frontend/my_img/Main/transmission.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-transmission">Transmission </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-drive-shaft">
                                                <img class="" src="/frontend/my_img/Main/drive_shaft.webp" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-drive-shaft">Drive Shaft</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-axle-shaft">
                                                <img class="" src="/frontend/my_img/Main/axleshaft.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-axle-shaft">Axle Shaft</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-floor-shifter">
                                                <img class="" src="/frontend/my_img/Main/floor_shifter.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-floor-shifter">Floor Shifter</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-cradle">
                                                <img class="" src="/frontend/my_img/Main/cradle.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-cradle">Cradle</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-crossmember">
                                                <img class="" src="/frontend/my_img/Main/crossmember.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-crossmember">Crossmember</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-subframe">
                                                <img class="" src="/frontend/my_img/Main/subframe.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-subframe">Subframe </a></h3>
                                                <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-shock-absorber">
                                                <img class="" src="/frontend/my_img/Main/shock_absorber.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-shock-absorber">Shock Absorber</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-rack-pinion">
                                                <img class="" src="/frontend/my_img/Main/rack_and_pinion.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-rack-pinion">Rack Pinion</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                            <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                            Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-control-arms">
                                                <img class="" src="/frontend/my_img/Main/control_arms.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-control-arms">Control Arms</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-braker-caliper-rotors">
                                                <img class="" src="/frontend/my_img/Main/braker_caliper.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-braker-caliper-rotors">Braker Caliper Rotors</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-power-steering-pump">
                                                <img class="" src="/frontend/my_img/Main/power_steering_pump.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-power-steering-pump">Power Steering Pump</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-steering-column">
                                                <img class="" src="/frontend/my_img/Main/steering_column.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-steering-column">Steering Column</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-strut">
                                                <img class="" src="/frontend/my_img/Main/strut.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-strut">Strut </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-ac-compressor">
                                                <img class="" src="/frontend/my_img/Main/ac_comporessor.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-ac-compressor">AC Compressor </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-ac-condenser">
                                                <img class="" src="/frontend/my_img/Main/ac-condenser.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-ac-condenser">AC Condenser </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-blower-motor">
                                                <img class="" src="/frontend/my_img/Main/blower-motor.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-blower-motor">Blower Motor </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-ac-heater-control-system">
                                                <img class="" src="/frontend/my_img/Main/ac_heater_control_system.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-ac-heater-control-system">AC Heater Control System </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                 ...
                                 <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-alternator">
                                                <img class="" src="/frontend/my_img/Main/alternators.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-alternator">Alternator</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                 ...
                                 <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-starter">
                                                <img class="" src="/frontend/my_img/Main/car_starter.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-starter">Starter</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                 ...
                                 <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-ignition-switch">
                                                <img class="" src="/frontend/my_img/Main/ignition_switch.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-ignition-switch">Ignition Switch</a></h3>
                                                <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                 ...
                                 <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-fuse-box">
                                                <img class="" src="/frontend/my_img/Main/fuse_box.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-fuse-box">Fuse Box</a></h3>
                                                <div class="mt-3" style="display: flex; justify-content: center;">
                                                    <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                        <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                        Enquire Now
                                 ...
                                 <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-instrument-cluster">
                                                <img class="" src="/frontend/my_img/Main/car_instrument.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-instrument-cluster">Instrument Cluster</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                 ...
                                 <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-wiper-motor">
                                                <img class="" src="/frontend/my_img/Main/wiper-motor.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-wiper-motor">Wiper Motor</a></h3>
                                                <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                 ...
                                 <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-window-motor-regulator">
                                                <img class="" src="/frontend/my_img/Main/window_motor_regulator.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-window-motor-regulator">Window Motor Regulator </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                 ...
                                 <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-cd-player-radio">
                                                <img class="" src="/frontend/my_img/Main/cd_player_radio.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-cd-player-radio">Cd Player Radio </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                 ...
                                 <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-tail-light">
                                                <img class="" src="/frontend/my_img/Main/tail_light.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-tail-light">Tail Light </a></h3>
                                                <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                 ...
                                 <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-headlight">
                                                <img class="" src="/frontend/my_img/Main/car_headlights.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-headlight">Headlight </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-fog-lamps">
                                                <img class="" src="/frontend/my_img/Main/fog_lamps.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-fog-lamps">Fog Lamps </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                 ...
                                 <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-abs-unit">
                                                <img class="" src="/frontend/my_img/Main/abs_unit.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-abs-unit">ABS Unit</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-fenders">
                                                <img class="" src="/frontend/my_img/Main/car_fenders.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-fenders">Fenders</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-hood">
                                                <img class="" src="/frontend/my_img/Main/hood.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-hood">Hood</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-doors">
                                                <img class="" src="/frontend/my_img/Main/car_doors.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-doors">Doors</a></h3>
                                                <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-mirrors">
                                                <img class="" src="/frontend/my_img/Main/mirror.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-mirrors">Mirrors</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-grilles">
                                                <img class="" src="/frontend/my_img/Main/car_grilles.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-grilles">Grilles</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-fender-flare">
                                                <img class="" src="/frontend/my_img/Main/car_fenders.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-fender-flare">Fender Flare </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-wheel-hub">
                                                <img class="" src="/frontend/my_img/Main/wheel_hub.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-wheel-hub">Wheel Hub </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-wheel-rim">
                                                <img class="" src="/frontend/my_img/Main/wheel_rim.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-wheel-rim">Wheel Rim </a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                    Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-seats">
                                                <img class="" src="/frontend/my_img/Main/seats.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">                                           
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-seats">Seats</a></h3>                                           
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-seat-belts">
                                                <img class="" src="/frontend/my_img/Main/seat_belt.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-seat-belts">Seat Belts</a></h3>                                               
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-center-console">
                                                <img class="" src="/frontend/my_img/Main/car_center_console.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-center-console">Center Console</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-sun-visor">
                                                <img class="" src="/frontend/my_img/Main/sun_visor.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-sun-visor">Sun Visor</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-air-bag">
                                                <img class="" src="/frontend/my_img/Main/air_bag.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-air-bag">Air Bag</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="/used-carparts/car-steering">
                                                <img class="" src="/frontend/my_img/Main/sterring_wheel.jpg" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__card--content">
                                            <h3 class="product__card--title text-center"><a href="/used-carparts/car-steering">Car Steering</a></h3>
                                            <div class="mt-3" style="display: flex; justify-content: center;">
                                                <a class="primary__btn slider__btn" href="tel:+1 (855) 581-5811">
                                                    <i class="fas fa-phone" style="margin-right: 8px;"></i>
                                                Enquire Now
            ...
            <div class="container">
                <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                    <div class="footer__logo">
                        <a class="footer__logo--link" href="/used-carparts/autoparts"><img src="/frontend/my_img/logo/new_logo.svg"
                                alt="logo-img"></a>
                    </div>
                    <p class="copyright__content"><span class="text__secondary">© 2025</span> Powered by <a
                            class="copyright__content--link" target="_blank" href="/used-carparts/autoparts">Spare Part Zone</a>
                        All Rights Reserved.
                    </p>
                </div>
            </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            logoLink.addEventListener("click", function (e) {
                ...
                if (currentPath === "/used-carparts/autoparts") {
...
<script>
    document.getElementById("productSearch").addEventListener("keyup", function() {
        ...
        let items = document.querySelectorAll(".custom-col");
        let visibleCount = 0;

        items.forEach(item => {
            let title = item.querySelector(".product__card--title").innerText.toLowerCase();
