@php
    ...
    $products = [
        [
            ...
            'link' => route('/used-carparts/alternator'),
        ],
        [
            'slug' => 'ac-compressor',
            ...
            'link' => route('/used-carparts/ac-compressor'),
        ],
        [
            'slug' => 'throttle-body',
            ...
            'link' => route('/used-carparts/throttle-body'),
        ],
        [
            'slug' => 'headlight',
            'name' => 'Car Headlight',
            ...
            'link' => route('/used-carparts/headlight'),
        ],
        [
            'slug' => 'transmission',
            ...
            'link' => route('/used-carparts/transmission'),
        ],
        [
            ...
            'link' => route('/used-carparts/catalytic-converter'),
        ],
    ];
