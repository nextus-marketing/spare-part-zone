...
@section('content')
    ...
    <div class="container">
        <div class="main__header--inner position__relative d-flex justify-content-center d-lg-none">
            <a href="/home" class="mobile-logo">
                <img src="/frontend/my_img/logo/new_logo.svg" alt="Spare Part Zone Logo" style="max-width: 90%;">
            </a>
        </div>
    </div>
                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="error__content text-center">
                            ...
                            <a class="error__content--btn primary__btn" href="/home"><i class="fa-solid fa-house"></i> Back To Home</a>
                        </div>
                    </div>
                </div>
            </div>
