...
@section('content')
    ...
    <main  style="font-family: 'Manrope', sans-serif;">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/car_headlights.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Headlight (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        High-Performance Headlights Light the Road Ahead
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        Your headlights are your first line of defense on the road—and at Spare Part Zone, we offer top-quality headlights built for performance, safety, and style. Choose from OEM replacements, LED, HID, or projector headlights tailored to your vehicle’s make and model. Whether you're replacing a damaged light or upgrading for better nighttime visibility, our headlights deliver a perfect blend of brightness, durability, and easy installation.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">What types of headlights do
                                            you offer?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">We carry halogen, LED, HID (Xenon), and
                                            projector headlights. Each type offers different benefits in terms of brightness,
                                            energy efficiency, and design.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Will these headlights fit
                                            my vehicle?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Yes! Use our vehicle selector tool to find
                                            headlights that match your car’s exact year, make, and model for a guaranteed fit.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Are LED headlights better
                                            than halogen?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">LED headlights are brighter, more
                                            energy-efficient, and last significantly longer than halogen bulbs. They're a
                                            popular upgrade for both style and performance.
                                    </p></div>
                                </div>
                            </div>
                        </div>
        ...
        @include('Frontend.relatedusedproduct', ['currentSlug' => 'headlight'])
