...
<style>
    ...
    <main  style="font-family: 'Manrope', sans-serif;">
                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/cylinder_head.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Cylinder-Head (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                            Precision Engineering for Optimal Engine Performance
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                            The cylinder head is a critical component of your engine, responsible for sealing the combustion chamber and housing essential parts like valves, spark plugs, and fuel injectors. At Spare Part Zone, we provide high-quality cylinder heads engineered to meet exact specifications and deliver superior performance and reliability.
                        </p>
        ...
        @include('Frontend.relatedusedproduct', ['currentSlug' => 'cylinder-head'])
