...
@section('content')
    ...
    <main  style="font-family: 'Manrope', sans-serif;">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/car-fender-flares.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Fender Flares (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Premium Quality Fender Flares Style and Protection for Your Ride
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        The front grille of your vehicle is more than just a design At Spare Part Zone, we bring you top-grade fender flares designed to enhance your vehicle’s style while providing superior protection. Whether you’re looking to give your car or truck a rugged, off-road look or simply need extra coverage for wider tires, our fender flares are crafted from durable materials built to withstand all weather conditions. Easy to install and perfectly fitting your vehicle’s contours, they help prevent mud, rocks, and road debris from damaging your paintwork. Upgrade your ride today with our premium selection of fender flares and enjoy a perfect combination of aesthetics and functionality.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">What are fender flares
                                            used for?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Fender flares extend the width of your
                                            vehicle’s fenders, providing extra coverage for larger tires and protecting your
                                            car’s body from mud, stones, and debris. They also add a stylish, custom look to
                                            your vehicle.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Are fender flares easy
                                            to install?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Yes. Most of our fender flares come with a
                                            simple bolt-on or clip-on installation process, and no major modifications are
                                            required. Each set includes detailed instructions for a hassle-free setup.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Do fender flares fit
                                            all car models?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Fender flares are model-specific. We offer
                                            options for a wide range of makes and models, so it’s important to select the
                                            product designed for your exact vehicle for a perfect fit.
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        @include('Frontend.relatedusedproduct', ['currentSlug' => 'supercharger'])
