                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/supercharger.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Super Charger (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                            Instant Power Boost for Your Engine
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                            At Spare Part Zone, we provide high-quality superchargers engineered for durability and maximum efficiency. Whether you’re upgrading for racing, towing, or just want more power on the road, our range of superchargers is designed to meet your performance needs with reliable fit and finish.
                        </p>
