...
@section('title')
    Intake Mainifold | Spare Part Zone
@endsection
@section('robots')
                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/intake_manifold.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Intake Mainifold (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                            Optimizing Airflow for Maximum Engine Performance
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                            At Spare Part Zone, we offer high-quality intake manifolds designed for optimal airflow, durability, and perfect fitment. Whether you're replacing a worn-out manifold or upgrading for enhanced engine efficiency, our intake manifolds meet OEM standards and deliver reliable performance.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> What does an intake
                                            manifold do?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">The intake manifold distributes the air-fuel
                                            mixture evenly to each engine cylinder, ensuring efficient combustion and engine
                                            performance.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc"> Common signs include engine misfires, reduced
                                            power, rough idling, coolant leaks, or a check engine light.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Can a faulty intake
                                            manifold affect fuel efficiency?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg"
                                                width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path
                                                    d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z"
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc"> Yes, leaks or blockages in the intake manifold
                                            can cause poor air-fuel mixture, leading to reduced fuel efficiency and performance.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Can I install the intake
                                            manifold myself?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg"
                                                width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Installation requires mechanical knowledge and
                                            tools. We recommend professional installation to ensure proper fit and function.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
