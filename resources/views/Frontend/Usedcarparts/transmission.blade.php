...
@section('content')
    ...
    <main  style="font-family: 'Manrope', sans-serif;">
                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/transmission.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Transmission (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Power Your Wheels with Smooth and Reliable Gear Shifts
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, we provide high-quality transmission units and components that ensure smooth gear shifting and reliable power delivery from your engine to the wheels. Whether you're looking to replace a failing transmission or upgrade for better performance, our transmissions are built to meet or exceed OEM standards. Available for both automatic and manual vehicles, our products are tested for durability, compatibility, and long-term reliability.
                        </p>
                        ...
                        <div class="faq__section--inner">
                            ...
                            <div class="accordion__container">
                                ...
                                <div class="accordion__items">
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">
                                            A transmission transfers power from the engine to the wheels, allowing your vehicle to change gears,
                                            control speed, and operate efficiently under different driving conditions.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">
                                            How do I know if my transmission needs replacement?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                        </button>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">
                                            Warning signs include delayed shifting, slipping gears, grinding noises, transmission fluid leaks,
                                            burning smells, or dashboard warning lights. A mechanic can confirm the issue.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">
                                            Can I repair my transmission instead of replacing it?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                        </button>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">
                                            Yes, minor issues like worn seals, sensors, or clutch components can often be repaired. Severe internal
                                            damage usually requires a full replacement.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">
                                            Do you offer transmissions for all vehicle types?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                        </button>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">
                                            We supply transmissions for a wide variety of makes and models, including automatic and manual systems.
        ...
        @include('Frontend.relatedusedproduct', ['currentSlug' => 'transmission'])
