                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/control_arms.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Control Arms (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Premium Quality for Smooth Handling
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, we understand that control arms are crucial components of your vehicle’s suspension system, providing stability and ensuring precise steering control. Our selection of high-quality control arms is designed to offer durability, superior performance, and a perfect fit for a wide range of vehicle makes and models.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">What is a control arm and
                                            why is it important?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">A control arm connects your vehicle’s suspension
                                            to the frame, allowing the wheels to move up and down while maintaining proper
                                            alignment. It plays a vital role in vehicle stability, steering response, and ride
                                            comfort.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Signs of worn control arms include clunking
                                            noises when driving over bumps, uneven tire wear, poor steering response, or
                                            vibrations. Regular inspections can help identify issues early to avoid further
                                            damage.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Can I install control arms
                                            myself, or should I seek professional help?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                        </button>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">While experienced DIYers might install control
                                            arms, it’s generally recommended to have a professional mechanic perform the
                                            installation to ensure safety, proper alignment, and optimal performance.
