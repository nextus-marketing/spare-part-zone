                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/car_doors.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Door (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        High-Quality Car Doors Built to Fit, Made to Last
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        Looking to replace a damaged or rusted door? At Spare Part Zone, we offer top-quality car doors for a wide range of vehicles, including sedans, SUVs, trucks, and vans. Our doors are manufactured to meet OEM standards for perfect fitment, durability, and safety. Whether you need a full door shell or just the outer skin, our selection ensures your vehicle looks great and functions like new. Built from high-strength steel or aluminum, our doors are primed and ready for painting and installation.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Do your doors include
                                            internal components like glass and handles?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Most replacement doors are sold as shells (outer
                                            panels only) without internal components. You’ll typically need to transfer parts
                                            like the window, mirror, lock, and door handle from your existing door or purchase
                                            them separately.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Are your doors a direct fit
                                            for my vehicle?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Yes, our doors are designed to match factory
                                            specifications for your vehicle’s make, model, and year. Use our vehicle search tool
                                            to find the exact fit.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Are the doors pre-painted?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                        </button>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">No, most doors come primed in black and are
                                            ready for custom painting. This allows for an exact color match to your vehicle's
                                            original finish.
                                        </p>
                                    </div>
                                </div>
