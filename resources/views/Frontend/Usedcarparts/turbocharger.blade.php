                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/turbo-charger.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Turbo Charger (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                            Boost Your Engine’s Power and Efficiency
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                            At Spare Part Zone, we offer premium turbochargers built with precision engineering and durable materials to ensure maximum reliability and performance. Whether you're looking to replace a worn turbocharger or upgrade for better acceleration and fuel economy, our selection features quality products tailored to your vehicle’s specifications.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">What is a turbocharger and
                                            how does it work?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">A turbocharger uses exhaust gases to spin a
                                            turbine connected to a compressor, which forces more air into the engine’s
                                            combustion chamber, increasing power and efficiency.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">How can I tell if my
                                            turbocharger is failing?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg"
                                                width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path
                                                    d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z"
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Signs include loss of power, excessive exhaust
                                            smoke, whining or unusual noises from the turbo, increased oil consumption, or a
                                            check engine light.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Can I replace just the
                                            turbocharger or do I need other parts?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg"
                                                width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path
                                                    d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z"
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Often, replacing the turbocharger alone is
                                            enough, but it’s advisable to inspect related parts like the intercooler, hoses, and
                                            oil lines during replacement.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> How long does a
                                            turbocharger typically last?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg"
                                                width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path
                                                    d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z"
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">With proper maintenance, turbochargers can last
                                            100,000 miles or more, but factors like driving conditions and oil quality can
                                            affect lifespan.</p>
                                    </div>
                                </div>
                            </div>
