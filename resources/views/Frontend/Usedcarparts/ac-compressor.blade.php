...
@section('title')
    AC Compressors | Spare Part Zone
@endsection
@section('robots')
...
@section('content')
    ...
    <main  style="font-family: 'Manrope', sans-serif;">
                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/ac_comporessor.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="AC Compressors (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        High-Performance AC Compressors for Reliable Cooling
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        Stay cool and comfortable with our premium AC compressors, engineered for maximum performance and durability. Whether you're replacing a worn-out unit or upgrading for better efficiency, our compressors deliver consistent cooling power and long-term reliability. Sourced from top-tier manufacturers and tested for quality, these components are perfect for both everyday drivers and automotive enthusiasts looking for dependable climate control.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> What does an AC compressor
                                            do in a car?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">The AC compressor is the heart of your car's air
                                            conditioning system. It compresses and circulates refrigerant to help remove heat
                                            from the cabin, keeping you cool.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> How do I know if my AC
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Common signs include warm air blowing from the
                                            vents, strange noises when the AC is on, or the AC clutch not engaging. A diagnostic
                                            check can confirm the issue.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Are your AC compressors
                                            new or refurbished?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">We offer 100% brand-new AC compressors, not
                                            refurbished units, ensuring maximum reliability and warranty protection.
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        @include('Frontend.relatedusedproduct', ['currentSlug' => 'ac-compressor'])
