                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/vacuum_pump.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Vacuum Pump (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Support Critical Engine Functions with Reliable Vacuum Power
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, we offer high-quality vacuum pumps designed to support essential engine systems such as brake boosters, turbochargers, and emissions controls. Our vacuum pumps provide consistent performance and are built to OEM specifications for a direct fit and long-lasting durability. Whether you’re replacing a failing unit or upgrading for better reliability, our vacuum pumps ensure your vehicle runs efficiently and safely.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">What does a vacuum pump do
                                            in a vehicle?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">A vacuum pump supplies vacuum pressure to
                                            systems like the brake booster, turbocharger, and emissions control devices,
                                            especially in vehicles where engine vacuum is insufficient.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">How do I know if my vacuum
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Common signs include poor braking performance,
                                            hissing noises, oil leaks around the pump, or a check engine light related to vacuum
                                            pressure loss.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Are these vacuum pumps new
                                            and do they come with a warranty?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                        </button>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Yes, all our vacuum pumps are brand new and come
                                            with a manufacturer-backed warranty (usually 1 year). Check the product page for
                                            specific coverage details.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Is installation difficult?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                        </button>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Installation depends on your vehicle’s make and
                                            model. Many vacuum pumps can be installed with basic tools, but for some vehicles,
                                            professional installation is recommended. Always consult your vehicle’s repair
                                            manual or a certified mechanic.</p>
                                    </div>
                                </div>
