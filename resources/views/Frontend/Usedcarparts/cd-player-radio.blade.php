...
@section('title')
   CD Player / Radio | Spare Part Zone
@endsection
@section('robots')
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/cd_player_radio.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="CD Player / Radio (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Quality CD Players & Radios for Premium In-Car Entertainment
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        Upgrade your vehicle’s audio system with our reliable CD players and radios, designed to deliver crystal-clear sound and seamless media playback. Whether you’re replacing a faulty unit or enhancing your car’s entertainment setup, our products are built to OEM standards for perfect compatibility and easy installation. Enjoy your favorite music, news, and radio stations with superior audio quality every drive.
                        </p>
                        ...
                        <div class="faq__section--inner">
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">
                                            What does a car CD player / radio system do?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">
                                            A car CD player and radio system provides entertainment by playing CDs, receiving radio signals, and often supporting Bluetooth, USB, and auxiliary inputs.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">
                                            What are common signs of a failing car radio or CD player?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                        </button>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">
                                            Common issues include no sound output, distorted audio, CDs not ejecting, connectivity problems, display failure, or the system not powering on.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">
                                            Can I upgrade my car’s CD player / radio system?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                        </button>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">
                                            Yes, most vehicles allow upgrades. Modern systems offer features like touchscreen displays, Apple CarPlay, Android Auto, improved sound quality, and wireless connectivity.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">
                                            Should I repair or replace a faulty car radio?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                        </button>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">
                                            Minor issues may be repairable, but replacement is often more cost-effective, especially if you want newer features and better performance.
                                        </p>
                                    </div>
                                </div>
                            </div>
