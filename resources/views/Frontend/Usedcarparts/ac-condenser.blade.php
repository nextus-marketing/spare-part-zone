                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/ac-condenser.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="AC Condensers (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Durable AC Condensers for Efficient Cooling Performance
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        Ensure optimal cooling in your vehicle with our high-quality AC condensers, designed for maximum heat exchange and long-lasting performance. Whether you're dealing with a failing condenser or upgrading for better air conditioning efficiency, our parts are built to meet or exceed OEM standards. Each condenser is precision-engineered to deliver consistent airflow and refrigerant cooling—keeping your car’s AC system running smoothly even in the hottest conditions.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">What is the role of an AC
                                            condenser in a car?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc"> The AC condenser cools down and condenses
                                            refrigerant vapor into liquid form by releasing heat, which is crucial for your
                                            car's air conditioning system to function properly.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> What are the signs of a
                                            bad AC condenser?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc"> Symptoms include weak or no cold air from the
                                            AC, visible refrigerant leaks, or overheating due to reduced airflow through the
                                            condenser.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Are your condensers
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">We stock a wide range of AC condensers
                                            compatible with various makes and models. Use our vehicle lookup tool or contact us
