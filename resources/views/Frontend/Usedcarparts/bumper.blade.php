                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/bumpers.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Bumper (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Premium Bumpers Protection Meets Style
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        Whether you’re replacing a damaged bumper or upgrading your vehicle’s appearance, Spare Part Zone has you covered with high-quality front and rear bumpers for all major makes and models. Designed for strength, fitment, and style, our bumpers restore your vehicle’s structural integrity while keeping it looking sharp. Choose from OEM replacements, sport-style bumpers, or off-road-ready designs—all crafted for easy installation and long-lasting performance.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">What types of bumpers do
                                            you offer?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">We offer OEM-style front and rear bumpers, sport
                                            or performance bumpers, off-road bumpers, and bumper covers. Materials range from
                                            plastic to steel depending on the vehicle type and purpose.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Are the bumpers painted or
                                            unpainted?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Most bumpers come unpainted and ready for
                                            customization. However, some models are available pre-painted in factory colors.
                                ...
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Do your bumpers include
                                            mounting hardware?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Some bumpers include mounting brackets and
                                            hardware, while others do not. Be sure to review the product description to see
                                            what’s included or order a separate installation kit if needed.
                                        </p>
                                    </div>
                                </div>
                            </div>
