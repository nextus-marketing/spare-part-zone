                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/hood.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Hood (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Premium Hoods Protection, Performance & Style
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        Your vehicle's hood isn't just about looks—it protects critical engine components while enhancing aerodynamics and overall safety. At Spare Part Zone, we offer a wide selection of high-quality replacement hoods that match OEM specifications for fit, strength, and style. Whether you're repairing collision damage, upgrading to a performance hood, or restoring a classic car, our hoods come primed and ready for painting. Available in steel, aluminum, or lightweight carbon fiber, each hood is designed to deliver durability, proper alignment, and long-lasting performance.
                        </p>
