                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/engine-mount.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Engine Mount (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Secure and Stabilize Your Engine
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, we offer durable engine mounts designed to fit perfectly and withstand harsh driving conditions. Whether you need a replacement due to wear or want to upgrade for enhanced durability, our engine mounts provide reliable support and comfort.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> What is the purpose of an
                                            engine mount?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Engine mounts secure the engine to the vehicle
                                            frame and absorb vibrations to reduce noise and movement.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc"> Signs include excessive engine vibration,
                                            clunking noises during acceleration or braking, engine movement visible under the
                                            hood, or uneven engine alignment.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Can a faulty engine mount
                                            damage other parts?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg"
                                                width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Yes, worn mounts can cause stress on hoses,
                                            wiring, and other engine components leading to premature wear or damage.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Are your engine mounts
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">We offer engine mounts for a wide range of
                                            vehicles. Please check product details or contact us for compatibility.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
