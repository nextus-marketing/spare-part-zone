                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/subframe.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Subframe (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Secure and Support Your Engine, Transmission, and Suspension Systems
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, we provide high-strength subframes designed to support your vehicle’s engine, transmission, and suspension components. Built from durable, corrosion-resistant materials, our subframes ensure proper alignment, absorb road impacts, and enhance overall vehicle stability. Whether you’re replacing a damaged subframe due to rust or collision, or upgrading for added reliability, our units are engineered to fit precisely and perform under demanding driving conditions.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">What is a subframe and what
                                            does it do?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">A subframe is a structural component that
                                            supports the engine, transmission, and suspension. It helps isolate vibrations,
                                            absorb road impacts, and maintain alignment of critical systems.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Signs include visible rust or cracks, poor
                                            handling, misalignment issues, or damage after a collision. A mechanic’s inspection
                                            can confirm the need for replacement.
                                ...
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Are your subframes new or
                                            refurbished?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">All of our subframes are brand new, made to
                                            meet or exceed OEM standards for safety and fitment.
                                        </p>
                                    </div>
                                </div>
