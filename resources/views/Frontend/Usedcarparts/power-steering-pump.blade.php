...
@section('title')
    Power Steering Pump | Spare Part Zone
@endsection
@section('robots')
            ...
            <div class="hero__slider--inner noninteractive-slider swiper">
                ...
                <div class="swiper-slide"
                    ...
                    <div class="about__thumb--items main-img">
                        <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/power_steering_pump.png" alt="about-thumb">
                    </div>
                    ...
                    <!-- 📦 START: FORM IN BANNER -->
                        <div class="banner__form">
                            ...
                            <form action="/lead-enquiry" method="POST" class="leadForm">
                                @csrf
                                 <input type="hidden" value="Power Steering Pump (Used Car Parts)" id="form_name" name="form_name">
                                <!-- ================= STEP 1 ================= -->
                                <div id="step-1">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <div style="
                        ...
                        color:#f7232a;
                        margin-bottom:10px;">
                     Effortless Control and Smooth Steering
                    </div>
                    ...
                    <p style="
                        ...
                        line-height:1.8;
                        color:#666;">
                     The power steering pump is a key component that ensures easy and responsive steering by circulating hydraulic fluid to assist your steering mechanism. At Spare Part Zone, we provide high-quality power steering pumps designed to deliver reliable performance and durability.
                    </p>
                        ...
                        <div class="accordion__container">
                            <div class="accordion__items">
                                <h3 class="accordion__items--title">
                                    <button class="faq__accordion--btn accordion__items--button">What role does the power
                                        steering pump play in my vehicle?
                                ...
                                <div class="accordion__items--body">
                                    <p class="accordion__items--body__desc">The power steering pump generates hydraulic
                                        pressure that assists in turning your steering wheel, making it easier to steer and
                                        maneuver your vehicle.</p>
                                </div>
                            </div>
                            <div class="accordion__items">
                                <h3 class="accordion__items--title">
                                    <button class="faq__accordion--btn accordion__items--button"> How can I tell if my power
                                        steering pump is failing?
                                        <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                            <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                        </svg>
                                    </button>
                                ...
                                <div class="accordion__items--body">
                                    <p class="accordion__items--body__desc">Signs include whining noises when turning the
                                        wheel, difficulty steering, fluid leaks, or a stiff steering wheel. Early detection
                                        can prevent more costly repairs.
                                    </p>
                                </div>
                            </div>
                            <div class="accordion__items">
                                <h3 class="accordion__items--title">
                                    <button class="faq__accordion--btn accordion__items--button"> Can I replace the power
                                        steering pump myself?
                                        <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                            <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                        </svg>
                                    </button>
                                ...
                                <div class="accordion__items--body">
                                    <p class="accordion__items--body__desc">While some experienced DIYers may attempt the
                                        replacement, it’s usually best to have a professional install the pump to ensure
                                        proper function and avoid damage to the steering system.
