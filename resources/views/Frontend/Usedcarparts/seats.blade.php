                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/seats.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Seats (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Premium Car Seats Comfort, Safety, and Style for Every Drive
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, we provide high-quality car seats designed to elevate your driving experience with unmatched comfort, safety, and style. Whether you’re upgrading to luxurious leather seats, adding sporty bucket seats, or replacing worn-out factory seats, our collection offers the perfect fit for your vehicle. Built with ergonomic designs, premium materials, and enhanced support, our seats help reduce fatigue during long drives while improving interior aesthetics. From daily commutes to adventurous road trips, our premium car seats make every journey a pleasure.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">What types of car seats
                                            do you offer?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">We offer a variety of seats including
                                            leather seats, fabric seats, racing bucket seats, and heated seats, catering to
                                            different comfort and style preferences.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Are your car seats
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Yes, but compatibility depends on your car’s
                                            make and model. We provide detailed specifications to ensure the perfect fit for
                                            your vehicle.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Do premium car seats
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Absolutely. High-quality seats offer better
                                            lumbar support, cushioning, and ergonomic design, reducing strain on your back
                                            and legs during long drives.
                                        </p>
                                    </div>
                                </div>
                            </div>
