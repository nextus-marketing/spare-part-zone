            ...
            <div class="hero__slider--inner noninteractive-slider swiper">
                ...
                <div class="swiper-slide"
                    ...
                    <div class="about__thumb--items main-img">
                        <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/car-radiator.png" alt="about-thumb">
                    </div>
                    ...
                    <!-- 📦 START: FORM IN BANNER -->
                        <div class="banner__form">
                            ...
                            <form action="/lead-enquiry" method="POST" class="leadForm">
                                @csrf
                                 <input type="hidden" value="Radiator (Used Car Parts)" id="form_name" name="form_name">
                                <!-- ================= STEP 1 ================= -->
                                <div id="step-1">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <p style="
                        ...
                        line-height:1.8;
                        color:#666;">
                       At Spare Part Zone, we offer high-performance radiators designed to keep your engine cool under all driving conditions. Our radiators provide efficient heat dissipation to prevent overheating and maintain optimal engine temperature. Whether you’re replacing a damaged unit or upgrading for better performance, our radiators are built from durable materials and designed for a perfect fit on a wide range of vehicles.
                    </p>
                        ...
                        <div class="accordion__container">
                            <div class="accordion__items">
                                <h3 class="accordion__items--title">
                                    <button class="faq__accordion--btn accordion__items--button"> How can I make sure this
                                        radiator fits my vehicle?
                                ...
                                <div class="accordion__items--body">
                                    <p class="accordion__items--body__desc">Use the fitment tool on the product page by
                                        entering your vehicle’s make, model, year, and engine type. You can also contact our
                                        support team for help with compatibility.</p>
                                </div>
                            </div>
                            <div class="accordion__items">
                                <h3 class="accordion__items--title">
                                    <button class="faq__accordion--btn accordion__items--button">Are these radiators brand
                                        new or refurbished?
                                        <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                            <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                        </svg>
                                ...
                                <div class="accordion__items--body">
                                    <p class="accordion__items--body__desc">All our radiators are brand new and meet or
                                        exceed OEM specifications. We do not sell used or refurbished radiators.</p>
                                </div>
                            </div>
                            <div class="accordion__items">
                                <h3 class="accordion__items--title">
                                    <button class="faq__accordion--btn accordion__items--button"> Do the radiators come with
                                        a warranty?
                                        <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                            <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                        </svg>
                                ...
                                <div class="accordion__items--body">
                                    <p class="accordion__items--body__desc">Yes, most of our radiators come with a 1-year
                                        limited warranty. Specific warranty information is listed on each product page.</p>
                                </div>
                            </div>
                            <div class="accordion__items">
                                <h3 class="accordion__items--title">
                                    <button class="faq__accordion--btn accordion__items--button"> Does the radiator come
                                        with installation hardware or a cap?
                                        <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                            <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                        </svg>
                                    </button>
                                ...
                                <div class="accordion__items--body">
                                    <p class="accordion__items--body__desc">Some radiators include necessary hardware or a
                                        cap, while others are sold as the core unit only. Please check the product
                                        description to see what’s included, or reach out to us for details.</p>
                                </div>
                            </div>
