...
@section('content')
    ...
    <main  style="font-family: 'Manrope', sans-serif;">
                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/throttle_body.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Throttle Body (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Precision Control for Engine Airflow
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, we offer high-quality throttle bodies designed to meet OEM specifications for durability and precision. Whether you’re replacing a faulty throttle body or upgrading for improved throttle response, our products deliver reliable performance and easy installation.
                        </p>
        ...
        @include('Frontend.relatedusedproduct', ['currentSlug' => 'throttle-body'])
