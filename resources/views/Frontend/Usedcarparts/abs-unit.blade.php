                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/abs_unit.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="ABS Unit (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        ABS Units Precision Braking, Maximum Safety
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        Stay in control when it matters most with our premium selection of ABS (Anti-lock Braking System) units. These advanced systems prevent wheel lock-up during sudden braking, helping you steer and stop safely especially in slippery or emergency conditions. At Spare Part Zone, we offer high-quality OEM and aftermarket ABS units that meet or exceed factory standards. Whether you're replacing a faulty module or upgrading for performance, our ABS units are tested for durability, compatibility, and performance.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">What is an ABS unit and how
                                            does it work?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">An ABS unit prevents your wheels from locking up
                                            during hard braking by rapidly pulsing the brakes, allowing you to maintain steering
                                            control and avoid skidding.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">How do I know if my ABS
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Common signs include the ABS warning light on
                                            your dashboard, reduced braking performance, or unusual brake pedal behavior. A
                                            diagnostic scan can confirm the issue.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Are your ABS units
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Yes, we offer ABS units for a wide range of
                                            makes and models. Use our vehicle lookup tool to ensure you get the exact fit for
                                            your car.
                                    </p></div>
                                </div>
                            </div>
