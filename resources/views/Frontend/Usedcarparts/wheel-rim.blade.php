                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/wheel_rim.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Wheel Rim (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Premium Alloy and Steel Wheel Rims Performance Meets Style
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, our collection of high-quality wheel rims is designed to transform your vehicle’s look and performance. Whether you’re after sleek alloy rims for a modern aesthetic or heavy-duty steel rims for maximum durability, we’ve got you covered. Our rims are precision-engineered for perfect fitment, improved handling, and enhanced road grip. Available in a variety of finishes and designs, they not only boost your car’s style but also ensure safe, stable rides in all conditions. Upgrade your vehicle’s personality and performance with our premium wheel rims today.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">What is the difference
                                            between alloy and steel rims?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Alloy rims are lightweight, stylish, and
                                            improve handling, while steel rims are heavier but offer maximum durability and
                                            are ideal for rugged conditions.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">How do I choose the
                                            right size wheel rims?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                        </button>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">You should select rims that match your
                                            vehicle’s specifications for diameter, width, and bolt pattern. Refer to your
                                            car’s manual or consult our fitment guide to ensure the perfect match.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Do new wheel rims
                                            improve performance?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Yes. High-quality rims can enhance
                                            handling, braking, and fuel efficiency, while also improving the overall
