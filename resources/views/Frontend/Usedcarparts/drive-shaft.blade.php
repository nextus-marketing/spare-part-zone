                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/drive_shaft.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Drive Shaft (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Transfer Power Smoothly from Transmission to Wheels
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, we offer durable and precision-engineered drive shafts designed to transfer torque efficiently from your vehicle’s transmission to the wheels. Our drive shafts are built to withstand high torque loads and rough driving conditions, ensuring smooth power delivery and reliable performance. Whether you need a replacement for a worn or damaged drive shaft or an upgrade for enhanced durability, our parts are made to fit perfectly and keep your drivetrain running smoothly.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">How do I know if my drive
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Signs include unusual vibrations, clunking
                                            noises during acceleration or turning, difficulty steering, or visible damage like
                                            dents or bends.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Are your drive shafts
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Each drive shaft listing includes compatibility
                                            details. Use our fitment tool by entering your vehicle’s make, model, and year, or
                                ...
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Do you sell complete drive
                                            shafts or individual components?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                        </button>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">We offer complete drive shafts as well as
                                            related components like U-joints and CV joints. Check the product description for
                                            specific items.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Can I install the drive
                                            shaft myself?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Installation can be complex and may require
                                            special tools and mechanical knowledge. We recommend professional installation to
                                            ensure safety and proper function.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
