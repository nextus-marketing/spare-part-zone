                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/fog_lamps.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Fog Lamp (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Premium Fog Lamps Clear Vision in Every Condition
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        Don’t let bad weather blur your drive. Our fog lamps are built to enhance visibility in low-visibility conditions such as fog, heavy rain, and snow. Designed for optimal beam spread and low-glare performance, our fog lamps improve road safety and add a sleek, functional touch to your vehicle’s front end. Available in halogen, LED, and projector styles, our fog lights offer perfect fitment, easy installation, and long-lasting durability.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">What’s the purpose of fog
                                            lamps?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Fog lamps are designed to provide a low, wide
                                            beam of light that cuts through fog, rain, snow, and dust, improving short-range
                                            visibility without reflecting light back into your eyes.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Are your fog lamps
                                            vehicle-specific?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Yes, our fog lamps are made to fit specific
                                            makes and models. Use our vehicle selector tool to find the perfect match for your
                                            car or truck.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Should I choose LED or
                                            halogen fog lamps?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">LED fog lamps offer brighter light, better
                                            energy efficiency, and longer lifespan than halogen. However, halogen lights are
                                            often more affordable and easier to replace.
                                    </p></div>
                                </div>
                            <div class="accordion__container">
                                <div class="accordion__items">
