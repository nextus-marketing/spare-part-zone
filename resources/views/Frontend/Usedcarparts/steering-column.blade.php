...
@section('title')
    Steering Columns | Spare Part Zone
@endsection
@section('robots')
            ...
            <div class="hero__slider--inner noninteractive-slider swiper">
                ...
                <div class="swiper-slide"
                    ...
                    <div class="about__thumb--items main-img">
                        <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/steering_column.png" alt="about-thumb">
                    </div>
                    ...
                    <!-- 📦 START: FORM IN BANNER -->
                        <div class="banner__form">
                            ...
                            <form action="/lead-enquiry" method="POST" class="leadForm">
                                @csrf
                                 <input type="hidden" value="Steering Columns (Used Car Parts)" id="form_name" name="form_name">
                                <!-- ================= STEP 1 ================= -->
                                <div id="step-1">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <div style="
                        ...
                        color:#f7232a;
                        margin-bottom:10px;">
                     Precision and Safety at Your Hands
                    </div>
                    ...
                    <p style="
                        ...
                        line-height:1.8;
                        color:#666;">
                     The steering column is a vital link between your steering wheel and the steering mechanism, ensuring precise control and responsiveness while driving. At Spare Part Zone, we offer durable and reliable steering columns engineered for a perfect fit and long-lasting performance. Whether you’re replacing a damaged column or upgrading your vehicle’s steering system, our premium parts guarantee safety, smooth operation, and enhanced driving confidence.
                    </p>
                        ...
                        <div class="accordion__container">
                            <div class="accordion__items">
                                ...
                                <div class="accordion__items--body">
                                    <p class="accordion__items--body__desc">The steering column connects the steering wheel
                                        to the steering mechanism, transmitting the driver’s input to control the direction
                                        of the vehicle.</p>
                                </div>
                            </div>
                            <div class="accordion__items">
                                <h3 class="accordion__items--title">
                                    <button class="faq__accordion--btn accordion__items--button"> How do I know if my
                                        steering column needs repair or replacement?
                                        <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                            <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                        </svg>
                                    </button>
                                ...
                                <div class="accordion__items--body">
                                    <p class="accordion__items--body__desc">Signs include unusual noises when turning the
                                        wheel, looseness or play in the steering wheel, or difficulty in steering. Any of
                                        these symptoms should be inspected promptly.
                                    </p>
                                </div>
                            </div>
                            <div class="accordion__items">
                                <h3 class="accordion__items--title">
                                    <button class="faq__accordion--btn accordion__items--button"> Are all steering columns
                                ...
                                <div class="accordion__items--body">
                                    <p class="accordion__items--body__desc">Steering columns are designed for specific
                                        makes and models, so it’s important to choose the correct part for your vehicle to
