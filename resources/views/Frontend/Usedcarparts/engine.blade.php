...
@section('content')
    ...
    <main  style="font-family: 'Manrope', sans-serif;">
                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/engine.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Engine (Used Car Parts)" id="form_name" name="form_name">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                            Powering Your Drive with Premium Quality
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                            At Spare Part Zone, we understand that the engine is the heart of your vehicle.
                            Whether you need replacement parts for repairs or upgrades to boost performance,
                            our extensive range of engine components ensures your car runs smoothly and efficiently.
                        </p>
                ...
                <div class="row align-items-start">
                    ...
                    <div class="col-lg-12 mt-5">
                        <div class="faq__section--inner">
                            ...
                            <div class="accordion__container mt-3">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Are Engines Tested Before
                                            Sale?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Yes, all used engines are inspected and tested
                                            for performance and reliability.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Do Engines Come With
                                            Warranty?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg"
                                                width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">All engine parts include a 1-year warranty
                                            covering defects and operational failure.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Can I Return a Engine If
                                            It Doesn’t Fit?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg"
                                                width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Yes, we accept returns within 15 days if the
                                            part is unused and in original condition.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">How Do I Confirm Engine
                                            Compatibility?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg"
                                                width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Share your VIN or part number with our support
                                            team to verify compatibility before purchase.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        @include('Frontend.relatedusedproduct', ['currentSlug' => 'engine'])
