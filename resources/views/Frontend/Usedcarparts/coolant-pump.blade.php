                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/coolant_pump.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Coolant Pump (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Efficiently circulates coolant to prevent engine overheating
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, we supply top-quality coolant pumps designed to keep your engine at the ideal operating temperature. Our coolant pumps ensure efficient circulation of coolant through the engine and radiator, helping prevent overheating and engine damage. Built for durability and precision, they are the perfect replacement for worn-out pumps and are engineered to deliver long-lasting performance in all driving conditions.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> How do I know if this
                                            coolant pump fits my vehicle?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Each coolant pump listing includes a
                                            compatibility chart or vehicle fitment information. Simply enter your car’s make,
                                            model, year, and engine size to ensure it’s the right part. If you’re unsure, our
                                            support team is here to help.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Are your coolant pumps OEM
                                            or aftermarket?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg"
                                                width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">We offer both OEM (Original Equipment
                                            Manufacturer) and high-quality aftermarket coolant pumps. All parts meet or exceed
                                            OEM standards to ensure reliability, performance, and durability.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> What is the warranty on
                                            your coolant pumps?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg"
                                                width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Most of our coolant pumps come with a 1-year
                                            limited warranty. Specific warranty details can be found on the product page. We
                                            stand behind the quality of our parts and offer hassle-free returns if needed.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
