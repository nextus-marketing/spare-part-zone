                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/fuel_pump.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Fuel Pump (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Ensure Reliable Fuel Delivery to Power Your Engine
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, we offer high-quality fuel pumps designed for reliability and optimal engine performance. Whether you're replacing a worn-out part or upgrading for improved fuel delivery, our fuel pumps provide consistent fuel flow to keep your engine running smoothly.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Common signs include difficulty starting the
                                            engine, loss of power while driving, engine sputtering at high speeds, or unusual
                                            whining noises coming from the fuel tank area.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> How often should a fuel
                                            pump be replaced?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg"
                                                width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Fuel pumps typically last between 100,000 to
                                            150,000 miles, but this can vary based on driving conditions, fuel quality, and
                                            vehicle maintenance. Always refer to your vehicle's service manual for specific
                                            recommendations.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Does a new fuel pump
                                            improve performance?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg"
                                                width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Replacing a worn or failing fuel pump can
                                            restore proper fuel pressure and delivery, which can lead to smoother engine
                                            performance, improved fuel efficiency, and reliable starting.</p>
                                    </div>
                                </div>
