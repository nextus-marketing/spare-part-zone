                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/seat_belt.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Seat Belts (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Durable and Safe Seat Belts Your First Line of Protection
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, we understand that safety comes first, which is why we offer high-quality seat belts engineered for maximum protection and comfort. Our seat belts are made from strong, wear-resistant webbing and feature reliable locking mechanisms to keep you secure in every driving condition. Whether you need a replacement for a worn or damaged belt, or you’re upgrading to a more advanced design, our selection ensures perfect fitment for your vehicle. Designed to meet strict safety standards, our seat belts combine durability, functionality, and ease of use to give you peace of mind on every journey.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">You should replace your seat belt if it
                                            shows signs of fraying, damage, difficulty retracting, or after a significant
                                            collision where it may have been stressed.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Are seat belts
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">While some aftermarket seat belts are
                                            universal, most replacements are designed to fit specific makes and models for
                                ...
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Do new seat belts
                                            improve safety?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Yes. A new, properly functioning seat belt
                                            ensures optimal restraint during sudden stops or accidents, significantly
