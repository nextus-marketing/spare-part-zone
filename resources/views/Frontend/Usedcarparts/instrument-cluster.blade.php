...
@section('title')
   Instrument Clusters | Spare Part Zone
@endsection
@section('robots')
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/car_instrument.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Instrument Clusters (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Precision Instrument Clusters for Clear and Accurate Display
                        </div>
                    ...
                    Instrument Clusters
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        Keep your vehicle’s dashboard information accurate and easy to read with our premium instrument clusters. This vital component provides real-time data such as speed, fuel level, engine temperature, and warning indicators, helping you stay informed and safe while driving. Our instrument clusters are engineered to meet or exceed OEM quality, ensuring a perfect fit and reliable performance for your specific vehicle model.
                        </p>
