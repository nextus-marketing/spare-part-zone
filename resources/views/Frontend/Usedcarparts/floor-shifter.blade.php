                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/floor_shifter.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Floor Shifter (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Precision Control Right at Your Feet
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, we offer high-quality floor shifters designed to provide smooth, precise gear changes for both manual and automatic transmissions. Our floor shifters are crafted from durable materials to withstand daily use and enhance your driving experience. Whether you’re replacing a worn-out shifter or upgrading to a more ergonomic design, our products ensure a perfect fit and reliable performance across a variety of vehicle makes and models.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">How do I know if this floor
                                            shifter fits my car?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Check the product description and compatibility
                                            chart by entering your vehicle’s make, model, and year. If you need assistance, our
                                            support team is ready to help.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Is the floor shifter
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">We offer floor shifters designed specifically
                                            for either manual or automatic transmissions. Please verify the product
                                ...
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Does the shifter come with
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Most of our floor shifters come with
                                            installation hardware, but some may require additional parts. Refer to the product
                                            details for what’s included.
                                        </p>
                                    </div>
                                </div>
