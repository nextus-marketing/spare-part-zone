                ...
                <div class="swiper-slide"
                    ...
                    <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/fuse_box.png" alt="about-thumb">
                        </div>
                        ...
                        <div class="banner__form">
                            ...
                            <form action="/lead-enquiry" method="POST" class="leadForm">
                                @csrf
                                <input type="hidden" value="Fuse Boxes (Used Car Parts)" id="form_name" name="form_name">
                                <!-- ================= STEP 1 ================= -->
                                <div id="step-1">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <div style="
                        ...
                        color:#f7232a;
                        margin-bottom:10px;">
                    Reliable Fuse Boxes for Safe Electrical Protection
                    </div>
                   ...
                   Fuse Boxes
                    ...
                    <p style="
                        ...
                        line-height:1.8;
                        color:#666;">
                    Protect your vehicle’s electrical system with our premium-quality fuse boxes. Designed to distribute power safely and prevent damage from short circuits or overloads, our fuse boxes are built to meet or exceed OEM standards. Whether you're replacing a damaged unit or upgrading a faulty system, our fuse boxes ensure your car’s electronics—from lights to sensors stay protected and functioning properly.
                    </p>
