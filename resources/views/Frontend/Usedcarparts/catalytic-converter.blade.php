...
@section('title')
    Catalytic Converter | Spare Part Zone
@endsection
@section('robots')
...
<style>
    ...
    <main  style="font-family: 'Manrope', sans-serif;">
                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/catalytic_converter.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Catalytic Converter (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        Our premium catalytic converters are engineered for maximum durability and efficiency, helping your vehicle meet emission standards while enhancing overall performance. Made with high-quality stainless steel and featuring a honeycomb ceramic structure, these converters ensure optimal exhaust flow and pollutant reduction. Whether you're replacing a faulty unit or upgrading for better performance, our catalytic converters are compatible with a wide range of vehicles and built to last.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> What does a catalytic
                                            converter do?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                        </button>
                                    </h3>
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">A catalytic converter reduces harmful emissions
                                            from your vehicle’s exhaust system by converting pollutants like carbon monoxide,
                                            hydrocarbons, and nitrogen oxides into less harmful gases before they are released
                                ...
                                <div class="accordion__items">
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Common signs include a decrease in engine
                                            performance, increased emissions, a rotten egg smell from the exhaust, or the check
                                            engine light turning on. A mechanic can diagnose the exact issue.
                                ...
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Is this catalytic converter
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Each catalytic converter lists the compatible
                                            makes and models in the product details section. Be sure to check your vehicle's
                                            year, make, model, and engine type, or contact our support team for assistance.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Do you offer installation
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">While we don’t provide installation services,
                                            many of our products include basic installation guides or reference videos. We
                                            always recommend having a certified mechanic handle the installation for best
                                            results.</p>
                                    </div>
                                </div>
                            </div>
        ...
        @include('Frontend.relatedusedproduct', ['currentSlug' => 'catalytic-converter'])
