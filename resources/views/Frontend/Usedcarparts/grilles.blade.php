                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/car_grilles.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Grilles (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Front Grilles Style, Protection & Performance
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        The front grille of your vehicle is more than just a design element—it plays a crucial role in airflow, engine cooling, and protecting internal components from debris. At Spare Part Zone, we offer a wide selection of high-quality replacement and custom grilles for all major makes and models. Whether you’re restoring your vehicle to factory condition or upgrading to a sportier or more aggressive look, our grilles are engineered for precise fitment, durability, and visual appeal. Choose from OE-style, mesh, honeycomb, chrome, matte black, and more.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">What types of grilles do
                                            you offer?
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">We offer OEM-style replacement grilles, custom
                                            grilles (e.g., mesh, billet, honeycomb), and specialty grilles with finishes like
                                            chrome, gloss black, and carbon fiber.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Will the grille fit my
                                            specific vehicle?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Yes, our grilles are designed to match your
                                            vehicle’s make, model, and year. Use our fitment tool to ensure compatibility before
                                            purchasing.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Are the grilles easy to
                                            install?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Most grilles are designed for direct replacement
                                            and can be installed with basic tools. Some custom grilles may require minor
                                            modifications—check product details for specifics.
                                        </p>
                                    </div>
                                </div>
                            </div>
