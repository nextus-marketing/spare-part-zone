...
<style>
    ...
    <main  style="font-family: 'Manrope', sans-serif;">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="hero__slider--items__style3 d-flex align-items-center justify-content-between">
                            <div class="about__thumb--items main-img">
                                <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/alternators.png" alt="about-thumb">
                            </div>
                            ...
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Alternator (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        High-Performance Alternators for Reliable Power Delivery
                        </div>
                    ...
                    Alternator
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        Keep your vehicle’s electrical system running strong with our premium-quality alternators. Designed for durability and efficiency, our alternators provide consistent power to your battery and essential components like headlights, infotainment systems, and onboard electronics. Whether you're replacing a failing unit or upgrading for better performance, our alternators are built to OEM standards for a perfect fit and long-lasting reliability.
                        </p>
        ...
        @include('Frontend.relatedusedproduct', ['currentSlug' => 'alternator'])
