                ...
                <div class="hero__slider--inner noninteractive-slider swiper">
                    ...
                    <div class="swiper-slide"
                        ...
                        <div class="about__thumb--items main-img">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/used-parts/axleshaft.png" alt="about-thumb">
                        </div>
                        ...
                        <!-- 📦 START: FORM IN BANNER -->
                            <div class="banner__form">
                                ...
                                <form action="/lead-enquiry" method="POST" class="leadForm">
                                    @csrf
                                    <input type="hidden" value="Axle Shaft (Used Car Parts)" id="form_name" name="form_name">
                                    <!-- ================= STEP 1 ================= -->
                                    <div id="step-1">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <div style="
                            ...
                            color:#f7232a;
                            margin-bottom:10px;">
                        Deliver Power from the Differential to Your Wheels with Confidence
                        </div>
                        ...
                        <p style="
                            ...
                            line-height:1.8;
                            color:#666;">
                        At Spare Part Zone, we offer high-quality axle shafts engineered to transfer torque efficiently from your vehicle’s differential to the wheels. Our axle shafts are built from durable materials designed to withstand heavy loads and tough road conditions, ensuring smooth power delivery and reliable performance. Whether you need a replacement for a damaged or worn axle shaft, or you’re upgrading for enhanced strength, our parts are precision-made for a perfect fit on a wide range of vehicles.
                        </p>
                            ...
                            <div class="accordion__container">
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">How do I know if my axle
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Signs include clicking or clunking noises when
                                            turning, vibrations during acceleration, grease leaks near the wheel, or visible
                                            damage to the axle shaft.</p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button"> Will this axle shaft fit
                                            my vehicle?
                                            <svg class="accordion__items--button__icon" xmlns="http://www.w3.org/2000/svg" width="20.355" height="13.394" viewBox="0 0 512 512">
                                                <path d="M98 190.06l139.78 163.12a24 24 0 0036.44 0L414 190.06c13.34-15.57 2.28-39.62-18.22-39.62h-279.6c-20.5 0-31.56 24.05-18.18 39.62z" fill="currentColor"></path>
                                            </svg>
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">Use our vehicle fitment tool or consult the
                                            product details to ensure compatibility. If you’re unsure, our customer support team
                                            can assist you.
                                        </p>
                                    </div>
                                </div>
                                <div class="accordion__items">
                                    <h3 class="accordion__items--title">
                                        <button class="faq__accordion--btn accordion__items--button">Are these axle shafts brand
                                    ...
                                    <div class="accordion__items--body">
                                        <p class="accordion__items--body__desc">We offer brand new axle shafts that meet or
                                            exceed OEM standards for quality and performance.
                                        </p>
                                    </div>
                                </div>
