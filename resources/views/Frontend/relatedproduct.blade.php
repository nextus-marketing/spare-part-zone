@php
    ...
    $products = [
        [
            ...
            'link' => route('/electrical-parts/alternator'),
        ],
        [
            'slug' => 'ac_compressor',
            ...
            'link' => route('/suspension-parts/ac-compressor'),
        ],
        [
            'slug' => 'throttle-body',
            ...
            'link' => route('/engine-parts/throttle-body'),
        ],
        [
            'slug' => 'headlight',
            'name' => 'Car Headlight',
            ...
            'link' => route('/electrical-parts/headlight'),
        ],
        [
            'slug' => 'transmission',
            ...
            'link' => route('/transmission-parts/transmission'),
        ],
        [
            ...
            'link' => route('/engine-parts/catalytic-converter'),
        ],
    ];
