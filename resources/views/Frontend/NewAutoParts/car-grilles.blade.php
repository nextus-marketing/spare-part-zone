                                ...
                                <div class="col-lg-6 col-md-6 col-12 text-center order-1 order-md-2">
                                    <div class="about__thumb--items main-img">
                                        <img class="about__thumb--img img-fluid"
                                            src="/frontend/my_img/used-parts/car_grilles.png"
                                            alt="Used Auto Parts">
                                    </div>
                                    </br>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div style="
                        ...
                        margin-bottom:10px;
                        text-align:center;">
                       <b>Front Grilles Style, Protection & Performance</b>
                    </div>
                    ...
                    <p style="
                        ...
                        line-height:1.8;
                        color:#666;">
                        At <b>Spare Part Zone</b>, we know that <b>Grilles</b> play a key role in both protecting your vehicle and enhancing its style. Positioned at the front, grilles allow air to flow to the radiator and engine compartment while shielding critical components from debris, stones, and other road hazards.
                        </br>
                       Signs that a grille may need replacement include cracks, broken slats, rust or corrosion, loose mounting, or visible damage from collisions. Timely replacement preserves engine cooling efficiency, maintains structural integrity, and keeps the vehicle looking sharp. Each grille in our inventory is carefully inspected for material quality, fit accuracy, and durability to ensure long-lasting performance.
                        </br>
                       We offer premium replacement grilles engineered for precise installation and reliable protection. Whether you’re performing a personal upgrade, servicing customer vehicles, or managing a fleet, our components are built to meet high standards while remaining cost-conscious.
                        </br>
                       Browse our catalog to select the correct grille for your vehicle’s make and model. Verify specifications, confirm compatibility, and take advantage of fast, secure delivery. Protecting your engine and enhancing your car’s front-end appearance is simple and affordable with Spare Part Zone.
                    </p>
