...
<main  style="font-family: 'Manrope', sans-serif;">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 text-center order-1 order-md-2">
                                    <div class="about__thumb--items main-img">
                                        <img class="about__thumb--img img-fluid"
                                            src="/frontend/my_img/used-parts/engine.png"
                                            alt="Used Auto Parts">
                                    </div>
                                    </br>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div style="
                        ...
                        margin-bottom:10px;
                        text-align:center;">
                       <b> Powering Your Drive with Premium Quality</b>
                    </div>
                    ...
                    <p style="
                        ...
                        line-height:1.8;
                        color:#666;">
                       At <b>Spare Part Zone</b>,we understand that the <b>Engine</b> is the heart of your vehicle. Whether you need replacement parts for repairs or upgrades to boost performance, our extensive range of engine components ensures your car runs smoothly and efficiently.
                        </br>
                        We offer a wide selection of quality car engines and engine components that help you restore performance without overspending. Whether you’re a DIY mechanic, a workshop professional, or just need a dependable replacement, our used engines deliver value, durability, and trusted performance.
                        </br>
                        Search our inventory now to find the right used engine for your vehicle. Compare options, check part details, and get fast delivery straight to your door. Your next engine overhaul just got easier and more affordable with Spare Part Zone.
                    </p>
    ...
    @include('Frontend.relatedusedproducttwo', ['currentSlug' => 'car-engine'])
