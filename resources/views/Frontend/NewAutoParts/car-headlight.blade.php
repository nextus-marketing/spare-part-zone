...
<main  style="font-family: 'Manrope', sans-serif;">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 text-center order-1 order-md-2">
                                    <div class="about__thumb--items main-img">
                                        <img class="about__thumb--img img-fluid"
                                            src="/frontend/my_img/used-parts/car_headlights.png"
                                            alt="Used Auto Parts">
                                    </div>
                                    </br>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div style="
                        ...
                        margin-bottom:10px;
                        text-align:center;">
                       <b>Headlights That Turn Heads Safety Meets Style</b>
                    </div>
                    ...
                    <p style="
                        ...
                        line-height:1.8;
                        color:#666;">
                        At <b>Spare Part Zone</b>, we understand that high-performing <b>Headlights</b> are vital for safe nighttime driving and clear visibility in challenging weather conditions. These front lighting assemblies illuminate the road ahead, improve peripheral awareness, and ensure your vehicle remains visible to oncoming traffic.
                        </br>
                       Common indications of headlight issues include dim or uneven beams, condensation inside the housing, cracked lenses, flickering illumination, or complete light failure. Driving with compromised headlights can significantly reduce visibility and increase accident risk. Each headlight unit in our inventory is thoroughly evaluated for lens clarity, reflector condition, beam alignment, sealing quality, and electrical functionality to guarantee dependable lighting performance.
                        </br>
                       We provide premium replacement headlights engineered for accurate fitment and optimal light output. Whether you’re completing a DIY repair, assisting customers in a professional garage, or overseeing fleet maintenance, our lighting solutions are built to meet high-quality standards while remaining cost-effective.
                        </br>
                       Browse our catalog to select the correct headlight assembly for your vehicle’s make and model. Confirm specifications, check compatibility, and take advantage of fast, secure shipping. Restoring bright, reliable road illumination is straightforward and affordable with Spare Part Zone.
                    </p>
    ...
    @include('Frontend.relatedusedproducttwo', ['currentSlug' => 'car-headlight'])
