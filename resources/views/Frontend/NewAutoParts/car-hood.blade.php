                                ...
                                <div class="col-lg-6 col-md-6 col-12 text-center order-1 order-md-2">
                                    <div class="about__thumb--items main-img">
                                        <img class="about__thumb--img img-fluid"
                                            src="/frontend/my_img/used-parts/hood.png"
                                            alt="Used Auto Parts">
                                    </div>
                                    </br>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div style="
                        ...
                        margin-bottom:10px;
                        text-align:center;">
                       <b>Premium Hoods Protection, Performance & Style</b>
                    </div>
                    ...
                    <p style="
                        ...
                        line-height:1.8;
                        color:#666;">
                        At <b>Spare Part Zone</b>, we understand that a sturdy <b>Hood</b> is essential for protecting your engine compartment and critical components from road hazards, weather, and debris. Beyond protection, it also contributes to your vehicle’s aerodynamics and overall aesthetic appeal.
                        </br>
                       Indicators that a hood may need replacement include dents or deep scratches, rust or corrosion, difficulty latching, misalignment with surrounding panels, or compromised structural integrity after a collision. Addressing these issues promptly helps safeguard the engine and maintain the vehicle’s appearance. Each hood in our inventory is meticulously inspected for material strength, precise fitment, hinge alignment, and surface finish to ensure long-lasting performance and durability.
                        </br>
                       We supply high-quality replacement hoods designed for seamless installation and reliable protection. Whether you’re handling a personal repair, servicing customers in a workshop, or managing fleet vehicles, our products are engineered to meet exacting standards while remaining cost-effective.
                        </br>
                       Explore our selection to find the right hood for your vehicle’s make and model. Confirm specifications, ensure compatibility, and benefit from fast, secure delivery. Maintaining optimal protection and a sleek exterior is easy and affordable with Spare Part Zone.
