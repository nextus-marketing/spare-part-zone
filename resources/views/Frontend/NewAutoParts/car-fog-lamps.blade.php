                                ...
                                <div class="col-lg-6 col-md-6 col-12 text-center order-1 order-md-2">
                                    <div class="about__thumb--items main-img">
                                        <img class="about__thumb--img img-fluid"
                                            src="/frontend/my_img/used-parts/fog_lamps.png"
                                            alt="Used Auto Parts">
                                    </div>
                                    </br>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div style="
                        ...
                        margin-bottom:10px;
                        text-align:center;">
                       <b>Premium Fog Lamps Clear Vision in Every Condition</b>
                    </div>
                    ...
                    <p style="
                        ...
                        line-height:1.8;
                        color:#666;">
                        At <b>Spare Part Zone</b>, we know that reliable <b>Fog Lamps</b> are essential for improving visibility in adverse weather conditions such as heavy rain, fog, or snow. Positioned low on the vehicle, these lights reduce glare and illuminate the road surface, helping you navigate safely when standard headlights may be less effective.
                        </br>
                       Signs that fog lamps may need attention include dim or flickering illumination, cracked or cloudy lenses, water intrusion inside the housing, or complete failure to activate. Ignoring these issues can compromise your ability to see the road and be seen by other drivers. Each fog lamp in our inventory is carefully tested for light output, housing durability, electrical connections, and alignment to ensure consistent performance.
                        </br>
                       We provide high-quality replacement fog lamps designed for precise installation and long-lasting reliability. Whether you’re performing a personal repair, servicing client vehicles in a garage, or managing a fleet, our components are built to meet strict standards while remaining budget-friendly.
                        </br>
                       Explore our range to find the correct fog lamp for your vehicle’s make and model. Verify specifications, confirm compatibility, and enjoy fast, secure delivery. Maintaining enhanced visibility and safer driving in challenging conditions is simple and cost-effective with Spare Part Zone.
                    </p>
