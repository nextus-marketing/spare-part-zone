...
@section('content')
                ...
                <div class="col">
                    <div class="breadcrumb__content text-center">
                        <ul class="breadcrumb__content--menu d-flex justify-content-center">
                            ...
                            <li class="breadcrumb__content--menu__items"><span>Alternator </span></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about__thumb d-flex">
                        <div class="about__thumb--items">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/Main/alternators.jpg"
                                alt="about-thumb">
                        </div>
                ...
                <div class="col-lg-6 mt-5">
                    <div class="about__content">
                        <span class="about__content--subtitle text__secondary mb-20">High-Performance Alternators for
                            Reliable Power Delivery</span>
                        <h2 class="about__content--maintitle mb-25">Alternator </h2>
                        <p class="about__content--desc mb-20">Keep your vehicle’s electrical system running strong with our
                            premium-quality alternators. Designed for durability and efficiency, our alternators provide
                            consistent power to your battery and essential components like headlights, infotainment systems,
                            and onboard electronics. Whether you're replacing a failing unit or upgrading for better
                            performance, our alternators are built to OEM standards for a perfect fit and long-lasting
                            reliability.
                        </p>
    ...
    @include('Frontend.relatedproduct', ['currentSlug' => 'alternator'])
@endsection
