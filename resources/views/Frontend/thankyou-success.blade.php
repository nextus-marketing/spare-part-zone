...
@section('content')
    ...
    <div class="header__bottom bg__primary home-ads-header">
        <div class="container">
            <div class="header__bottom--inner position__relative d-flex align-items-center" style="width:100%;">


                <!-- CENTERED LOGO -->
                <div class="site-logo pb-0 pt-0"
                    style="flex:1; display:flex; justify-content:center; align-items:center;">
                    <a href="/used-carparts" style="display:block;">
                        <img src="/frontend/my_img/logo/new_logo.svg" alt="Spare Part Zone Logo" style="max-width:130px;  margin-left: 1022px;">
                    </a>
                </div>


                <!-- RIGHT AREA -->
                <div class="header__right--area d-flex align-items-center" style="gap:10px;">


                    <!-- Call Now Button -->
                    @if (!request()->is('home') && !request()->is('thankyou-lead'))
                    <a href="tel:+1 (855) 581-5811" class="mobile-call-button" style="
                        display:flex;
                        align-items:center;
                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="error__content text-center">
                            <h2 class="error__content--title">Part Request Recieved !</h2>
                            <p class="error__content--desc">Our team is verifying and may reach out to insure we are quoting you the correct part.</p>
                            <p class="error__content--desc">Need an immediate price? Call our parts counter:</p>
                            <a class="error__content--btn primary__btn" href="tel:+18555815811"><i class="fa-solid fa-phone"></i> +1 (855) 581-5811</a>
                        </div>
                    </div>
                </div>
            </div>
