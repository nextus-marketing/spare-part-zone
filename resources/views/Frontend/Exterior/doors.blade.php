...
@section('content')
                ...
                <div class="col">
                    <div class="breadcrumb__content text-center">
                        <ul class="breadcrumb__content--menu d-flex justify-content-center">
                            ...
                            <li class="breadcrumb__content--menu__items"><span>Door </span></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="about__thumb d-flex">
                        <div class="about__thumb--items">
                            <img class="about__thumb--img border-radius-5" src="/frontend/my_img/Main/car_doors.jpg"
                                alt="about-thumb">
                        </div>
                ...
                <div class="col-lg-6 mt-5">
                    <div class="about__content">
                        ...
                        <p class="about__content--desc mb-20">Looking to replace a damaged or rusted door? At Spare Part Zone, we offer top-quality car doors for a wide range of vehicles, including sedans, SUVs,
                            ...
                            aluminum, our doors are primed and ready for painting and installation.
                        </p>
    ...
    @include('Frontend.relatedproduct', ['currentSlug' => 'doors'])
@endsection
